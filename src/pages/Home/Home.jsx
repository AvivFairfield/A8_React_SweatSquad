...
export const Home = () => {
    ...
    return (
        <div className="text-center grid place-items-center p-3">
            ...
            <p
                id="welcome_msg"
                className="text-xl text-center py-1 text-white "
            ></p>
            {/* Displaying a welcome message with the user's name */}
            <p
                id="welcome_msg"
                className={`text-xl text-center py-1  ${theme}`}
            >
            ...
            <div className="w-5/6 max-w-xl bg-neutral-600 p-3 my-5 rounded-3xl text-white overflow-hidden">
                <div className="news-content ">
                    ...
                    <p>
                        For every new friend you bring in you are getting a free
                        lesson!.
                    </p>
                </div>
            </div>
